...
const projects = () => {
  ...
  <div className="max-w-[1000px] h-full mx-auto grid gap-6 p-6 sm:p-10 lg:p-20">
    ...
    <h1 className='text-3xl sm:text-5xl font-extrabold 
                      ...
                      text-transparent bg-clip-text drop-shadow-lg'>My Projects</h1>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-6 md:gap-8 lg:gap-10">
      ...
      {/* CARD 3 */}
      <a href="https://hsm.aero"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 4 */}
      <a href="http://lcslogistics.com"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 10 */}
      <a href="https://wordpress-1091546-4178418.cloudwaysapps.com/"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 5 */}
      <a href="https://mg-computing.com/siteb/"></a>
      <div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 6 */}
      <a href="https://mpm.house"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 7 */}
      <a href="https://spotlight-accounting.co.uk"></a>
      <div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 8 */}
      <a href="https://keystone-invest.co.uk"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
      ...
      {/* CARD 9 */}
      <a href="https://agility-outsourcing.co.uk"><div className="w-full max-w-full mx-auto grid gap-6 border p-6 bg-neutral-950/80 border-slate-600/20 rounded-4xl hover:bg-orange-700/80 hover:border-orange-500/90 cursor-pointer duration-300">
