...
const homepage = () => {
  return (
    <div className="m-10 p-10">
      {/* First Section */}
      <div
        style={{ background: "#140c1c", borderColor: "#2a1454" }}
        className="max-w-[1200px] border rounded-2xl border-white/40 mx-auto grid xl:grid-cols-8  md:grid-cols-2 gap-6 p-10 md:p-10 md:py-12"
      >
          ...
          <div className="my-auto ml-10 flex-col">
            <div className="py-5 flex justify-start gap-4">
              <a
                ...
                className="rounded-full border-1 border-white p-2.5 hover:bg-violet-700 hover:border-violet-700 hover:text-white transition-colors duration-300"
              >
            ...
            <div className="pt-8">
              <a
                href="http://"
                className="mt-200 text-white font-bold rounded-full border-1 border-white py-3 px-5 hover:bg-violet-700 hover:border-violet-700 transition-colors duration-300"
              >
                Download CV
              </a>
            </div>
