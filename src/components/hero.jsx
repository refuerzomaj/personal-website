...
const hero = () => {
  return (
    <div
      className="bg-gradient-to-tr from-gray-900 via-black py-40 to-gray-900 h-full z-5"
      id="home"
    >
      <div
      ...
      >
        ...
        <div className="order-2 md:order-1 animate-slide-in-left px-10 col-span-1 sm:col-span-2 md:col-span-3 xl:col-span-1 grid grid-cols-1 items-center h-100 rows-start-2">
          <div className="grid grid-cols-1 gap-4">
            <h1 className="font-bold text-white pb-2 text-xl sm:text-2xl md:text-2xl xl:text-3xl">
              Hi, I am Jomardon
            </h1>
            <h1
            ...
            <p className="text-white text-[20px] leading-8 sm:w-full md:w-110 xl:w-130">
          ...
          <div className="w-100 h-100 rounded-full">
            <center>
              <img
                ...
                src={myPhoto}
                alt="Jomardon Gabitanan web developer Philippines"
              />
            </center>
          </div>
        </div>
